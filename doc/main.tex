...
\section{GB Transfer Actors}
\label{sec:gb-transfer-actors}

These Gigabit Transfer Actors are used to transfer high rates of data.
There is some overhead in the DD that occurs in the Actors.
This Actor does not use the DD methods for messaging, and uses functional reentrant methods instead.
...
\begin{figure}
    \centering
    \includegraphics[width=0.8\textwidth]{figures/event-loop}
...
\begin{figure}
    \centering
    \includegraphics[width=0.8\textwidth]{figures/palette}
    \caption{Palette. This shows the palette in jettl.}
    \label{fig:palette}
\end{figure}
...
\begin{figure}
    \centering
    \includegraphics[width=0.8\textwidth]{figures/queue-actor-method}
...
\begin{figure}
    \centering
    \includegraphics[width=0.8\textwidth]{figures/event-actor-method}
...
\begin{figure}
    \centering
    \includegraphics[width=0.8\textwidth]{figures/alternate-start-async}
